            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="time" name="time" type="text" class="form-control" placeholder="{{ __('Время аренды') }} *" required="" aria-required="true" autocomplete="off" style="min-width: 95%!important;">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <img src="{{ asset('/assets/geo.png') }}" class="fa input-icon" width="32px">
                <input id="start_address" name="start_address" type="text" class="form-control" placeholder="{{ __('Адрес подачи автомобиля') }}" aria-required="true" autocomplete="off" style="min-width: 95%!important;">
            </div>
            <div class="form-group">
                <img src="{{ asset('/assets/geo.png') }}" class="fa input-icon" width="32px">
                <input id="end_address" name="end_address" type="text" class="form-control" placeholder="{{ __('Адрес окончания заказа') }}" aria-required="true" autocomplete="off" style="min-width: 95%!important;">
            </div>

            <div class="form-group">
                <img src="{{ asset('/assets/trees.png') }}" class="fa input-icon" width="32px">
                <input id="out_city" name="out_city" type="text" class="form-control" placeholder="{{ __('Выезд за город') }}" aria-required="true" autocomplete="off" style="min-width: 95%!important;">
            </div>
            <!-- <div class="form-group">
...
<script>
    ...
    if (document.querySelector('#order_modal_{{ $car->id }}')) {
        document.querySelector('#order_modal_{{ $car->id }}').addEventListener('submit', (e) => {
            e.preventDefault();
            const form = e.target;
